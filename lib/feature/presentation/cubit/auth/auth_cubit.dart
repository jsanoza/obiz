...
import 'package:sample_app_request/feature/domain/use_cases/get_current_id_uc.dart';
import 'package:sample_app_request/feature/domain/use_cases/is_signed_in_uc.dart';
import 'package:sample_app_request/feature/domain/use_cases/sign_out_uc.dart';

part 'auth_state.dart';

class AuthCubit extends Cubit<AuthState> {
  AuthCubit(this.getCurrentIdUseCase, this.isSignedInUseCase, this.signOutUseCase) : super(AuthInitial());
